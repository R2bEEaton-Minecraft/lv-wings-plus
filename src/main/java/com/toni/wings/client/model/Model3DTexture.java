...
public final class Model3DTexture extends ModelPart.Cube {
    ...
    @Override
    public void compile(PoseStack.Pose pose, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        super.compile(pose, SodiumBypassVertexConsumer.wrap(buffer), packedLight, packedOverlay, red, green, blue, alpha);
    }
